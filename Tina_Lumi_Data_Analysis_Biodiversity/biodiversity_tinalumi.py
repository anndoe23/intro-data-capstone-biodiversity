...
species['is_sheep'] = species.apply(lambda row: 'sheep' in row['common_names'].lower(), axis=1)
species.head()
...
min_detectable_effect = 5. / 15 * 100
...
obs_yellowstn_park = obs_by_park[(obs_by_park.park_name == 'Yellowstone National Park')].observations
